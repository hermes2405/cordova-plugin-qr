...
public class PrinterCommand {
   ...
   /**
    * 打印并走纸 (0~255)   -- Imprimir y alimentar papel (0 ~ 255)
    * @param feed
    * @return
    */
   ...
   /**
    * 蜂鸣指令    -- Instrucciones de pitido
    * @param m  蜂鸣次数       -- El número de pitidos
    * @param t  每次蜂鸣的时间  -- Cada tiempo de pitido
    * @return
    */
   ...
   /**
    * 切刀指令(走纸到切刀位置并切纸)    -- Comando de cortador (ir a la posición del cortador y cortar el papel)
    * @param cut  0~255
    * @return
    */
   ...
   /**
    * 钱箱指令    -- Instrucciones de caja de efectivo
    * @param nMode
    * @param nTime1
    * @param nTime2
    * @return
   ...
   public static byte[] POS_Set_CodePage(int page){
	...
	/**
	 * 打印文本文档    -- Imprimir un documento de texto
	 * @param pszString  	要打印的字符串                       	-- Cadena para imprimir
	 * @param encoding   	打印字符对应编码						-- Imprimir caracteres correspondientes al código
	 * @param codepage      设置代码页(0--255)					-- Establecer página de códigos (0-255)
	 * @param nWidthTimes   倍宽(0--4)							-- Ancho de Tiempos (0 - 4)   --> ancho de la fuente
	 * @param nHeightTimes  倍高(0--4)							-- Alto de tiempos (0 - 4)    --> alto de la fuente
	 * @param nFontType     字体类型(只对Ascii码有效)(0,1 48,49)	-- Tipo de fuente (válido solo para Ascii) (0,1 48,49)
	 */
	...
	/**
	 * 加粗指令(最低位为1有效) --- Instrucciones en negrita (la más baja es válida)
	 * @param bold
	 * @return
	 */
	...
	/**
	 * 设置倒置打印模式(当最低位为1时有效)   -- Establezca el modo de impresión invertida (válido cuando el bit menos significativo es 1)
	 * @param brace
	 * @return
	 */
	...
	/**
	 * 选择字体大小(倍高倍宽)     -- Elija el tamaño de la fuente (veces mayor ancho)
	 * @param size1
	 * @return
	 */
	...
	/**
	 * 选择字体字型    -- Elige una fuente fuente
	 * @param font
	 * @return
	 */
...
//***********************************以下函数为公开函数 (La siguiente función es una función pública)**********************************//
	/**
	 * 二维码打印函数    --Función de impresión de código bidimensional (QR)
	 * @param str                     打印二维码数据 	 --Imprimir datos de código bidimensional
	 * @param nVersion				      二维码类型  --Tipo de código bidimensional
	 * @param nErrorCorrectionLevel   纠错级别		 --Nivel de corrección de errores
	 * @param nMagnification          放大倍数		 -- Aumento
	 * @return
	 */
	...
	/**
	 * 打印一维条码			-- Imprima un código de barras unidimensional
	 * @param str                   打印条码字符
	 ...
	 * 				-- Establezca el modo de impresión (fuente: una fuente: B), negrita, el doble de ancho (hasta 4 veces más de ancho)
	 * @param str          打印的字符串     	-- cadena a imprimir
	 * @param bold		         加粗      	-- Negrita
	 * @param font		         选择字型   	-- Elige la fuente    0 o 1
	 * @param widthsize    倍宽
	 * @param heigthsize   倍高
	 * @return
	 */
